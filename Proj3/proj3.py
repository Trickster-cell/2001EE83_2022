...
print("-"*25)
st.title("Project3")
print('1. C', '2. S', '3. A', '4. C & S', '5. C & A',
      '6. S & A', '7. C & S & A', '8. all combine', sep='\n')
tch = int(st.number_input("Enter Filtering Method:", min_value=1, max_value=7))
# submitted = False
sch = 0
corr = 0
SNR = 0
...
if (st.button("Submit", key=1)):
    with(st.form("MY form")):
        if tch == 1:
            ...
            st.text("Replacement Methods:")
            st.text("1. previous point")
            st.text("2. 2*last-2nd_last")
            st.text("3. overall_mean")
            st.text("4. 12_point_strategy")
            st.text("5. mean of previous 2 point")
            st.text("6. all seqential")
            st.text("7. all parallel")
            sch = int(st.number_input("Enter Replacement Method Number", min_value=1, max_value=7))
...
if sch > 7:
    ...
    # st.text("All Input files processed.")
    print("-------------------------------------------------------------------")
print("*"*25)
